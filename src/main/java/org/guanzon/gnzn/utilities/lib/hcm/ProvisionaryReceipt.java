...
public class ProvisionaryReceipt implements ILoveMyJobValidator{
    private final String _code = "panalo.ilmj.field.payment";
    ...
    private String getSQ_Master(String fsBranchCd, String fsDateFrom, String fsDateThru){
        return "SELECT" +
                ...
                " FROM Provisionary_Receipt_Master a" +
                    ...
                    " LEFT JOIN Checks_Received f ON a.sTransNox = f.sReferNox AND f.sSourceCD = 'PRec'" +
