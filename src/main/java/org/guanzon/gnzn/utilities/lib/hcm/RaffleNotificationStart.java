...
// * @author User
// */
//public class RaffleNotificationStart implements ILoveMyJobValidator{
//     
...
//                String _body = "Attention everyone!\\\n \\\n \\\n"  +
//                            "We are excited to announce that our raffle draw has officially begun! This is your chance to win amazing prizes, so make sure you have your tickets ready.\n" +
//                            "\\\n \\\n" +
//                            "The draw will take place on "+ dateToWord(fsRaffleDt) + " at " + dateToTime(fsRaffleDt) + ", and winners will be notified through  the guanzon mobile application.\n" +
//                            "\\\n \\\n" +
//                            "Good luck to everyone who entered, and thank you for your support!";
//               
//                if(!WebClient.SendSystemPanaloRaffleStartEndNotification("gRider", loMaster.getString("sUserIDxx"), "I Love My Job", _body,2)){
