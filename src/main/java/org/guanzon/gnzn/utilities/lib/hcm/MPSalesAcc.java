...
public class MPSalesAcc implements ILoveMyJobValidator{
    private final String _code = "panalo.ilmj.mp.accessories";
    ...
    private String getSQ_Master(String fsBranchCd, String fsDateFrom, String fsDateThru){
        return "SELECT" +
                ...
                " FROM CP_SO_Master a" +
                    " LEFT JOIN CP_SO_Detail d ON a.sTransNox = d.sTransNox" +
                    " LEFT JOIN RaffleEntries b" +
                    " ON LEFT(a.sTransNox, 4) = b.sBranchCD" +
                        " AND a.sSalesInv = b.sReferNox" +
