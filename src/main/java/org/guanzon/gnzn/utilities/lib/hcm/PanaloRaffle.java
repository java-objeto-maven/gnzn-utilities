 ...
 * @author User
 */
public class PanaloRaffle implements ILoveMyJobValidator{
    ...
    public boolean Run(String fsTransNox, String fsRaffleDt, String fsRemarks) {
        ...
        try {
            ...
            while (loMaster.next()){                
                ...
                String _body = "Hello " + loMaster.getString("sFullName") + ", we would like to remind you that there will be a raffle draw on " +
                    dateToWord(fsRaffleDt) + " at " + dateToTime(fsRaffleDt) + ".";
